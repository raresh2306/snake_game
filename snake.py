...
class FRUIT:
    ...
    def draw_fruit(self):  # Moved back to be a method of the class
...
class MAIN:
    ...
    def draw_score(self):
        ...
        score_surface = game_font.render(score_text,True ,(152, 3, 252))
        ...
        pygame.draw.rect(screen, (152, 3, 252), bg_rect, 2)
...
apple = pygame.image.load('Visual/marul.png').convert_alpha()

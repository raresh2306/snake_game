This project is entirely based on a pygame module. Can be used in any educational and professional uses. Snake body and head are graphics owned by Google Ltd. 
